...
- **예제**: `5 / 1 2 3 4 5` → `4 2`  (끝 원소 5가 피벗이면 좌측에 1,2,3,4로 4개. 첫·중간·끝 1,3,5의 중앙값 3이 피벗이면 좌측에 1,2로 2개)
- **예제**: `5 / 5 4 3 2 1` → `0 2`  (끝 원소 1이 피벗이면 좌측이 비어 0개. 5,3,1의 중앙값 3이 피벗이면 좌측에 2,1로 2개)
...
- **예제**: `3 / 1 a / 1 b / 2 c` → `0`  (안정 정렬은 a,b,c. 동점 라벨이 뒤집힌 불안정 정렬은 b,a,c라서 인덱스 0에서 다름)
